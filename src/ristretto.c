...
static const scalar_t point_scalarmul_adjustment = {{
															SC_LIMB(0xd6ec31748d98951c), SC_LIMB(
				0xc6ef5bf4737dcf70), SC_LIMB(0xfffffffffffffffe), SC_LIMB(0x0fffffffffffffff)
													}}, precomputed_scalarmul_adjustment = {{
																									SC_LIMB(0x977f4a4775473484), SC_LIMB(
				0x6de72ae98b3ab623), SC_LIMB(0xffffffffffffffff), SC_LIMB(0x0fffffffffffffff)
																							}};
...
/** identity = (0,1) */
const point_t ristretto255_point_identity = {{{0}},
											 {{1}},
											 {{1}},
											 {{0}}};
...
void ristretto255_point_double_scalarmul(
	...
	/* Set up a precomputed table with odd multiples of b. */
	pniels_t pn, multiples1[1 << ((int) (RISTRETTO_WINDOW_BITS) - 1)], multiples2[
			1 << ((int) (RISTRETTO_WINDOW_BITS) - 1)];
...
void ristretto255_point_dual_scalarmul(
	...
	/* Set up a precomputed table with odd multiples of b. */
	point_t multiples1[1 << ((int) (RISTRETTO_WINDOW_BITS) - 1)], multiples2[
			1 << ((int) (RISTRETTO_WINDOW_BITS) - 1)], working, tmp;
...
void ristretto255_precompute(
	...
	gf_25519_t zs[(unsigned int) (COMBS_N) << (unsigned int) (COMBS_T - 1)], zis[
			(unsigned int) (COMBS_N) << (unsigned int) (COMBS_T - 1)];
