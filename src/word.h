...
mask_to_bool (mask_t
m) {
return (ristretto_sword_t)(sword_t)
m;
}

static RISTRETTO_INLINE mask_t
bool_to_mask (ristretto_bool_t
m) {
...
static RISTRETTO_INLINE void ignore_result(ristretto_bool_t
boo ) {
(void)
boo;
}
