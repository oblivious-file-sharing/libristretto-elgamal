...
static const scalar_t sc_p = {{
									  SC_LIMB(0x5812631a5cf5d3ed), SC_LIMB(0x14def9dea2f79cd6), SC_LIMB(
				0x0000000000000000), SC_LIMB(0x1000000000000000)
							  }}, sc_r2 = {{
												   SC_LIMB(0xa40611e3449c0f01), SC_LIMB(0xd00e1ba768859347), SC_LIMB(
				0xceec73d217f5be65), SC_LIMB(0x0399411b7c309a3d)
										   }};
